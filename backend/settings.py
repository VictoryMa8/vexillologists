"""Django settings shared by local development and production."""
...
# Fly terminates TLS and forwards the original protocol in this header.
...
DEFAULT_FROM_EMAIL = 'Vexillologists <noreply@vexillologists.com>'
...
# Cross-site OAuth callbacks need the session cookie in production.
